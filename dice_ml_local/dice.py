...
from dice_ml_local.constants import BackEndTypes, SamplingStrategy
from dice_ml_local.data_interfaces.private_data_interface import PrivateData
from dice_ml_local.explainer_interfaces.explainer_base import ExplainerBase
from dice_ml_local.utils.exception import UserConfigValidationException
...
def decide(model_interface, method):
    ...
    if model_interface.backend == BackEndTypes.Sklearn:
        if method == SamplingStrategy.Random:
            ...
            from dice_ml_local.explainer_interfaces.dice_random import DiceRandom
            return DiceRandom
        elif method == SamplingStrategy.Genetic:
            from dice_ml_local.explainer_interfaces.dice_genetic import DiceGenetic
            return DiceGenetic
        elif method == SamplingStrategy.KdTree:
            from dice_ml_local.explainer_interfaces.dice_KD import DiceKD
            return DiceKD
        else:
        ...
        from dice_ml_local.explainer_interfaces.dice_tensorflow1 import \
            DiceTensorFlow1
        ...
        from dice_ml_local.explainer_interfaces.dice_tensorflow2 import \
            DiceTensorFlow2
        return DiceTensorFlow2

    elif model_interface.backend == BackEndTypes.Pytorch:
        # PyTorch backend
        from dice_ml_local.explainer_interfaces.dice_pytorch import DicePyTorch
        return DicePyTorch
