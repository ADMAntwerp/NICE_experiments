...
from dice_ml_local.constants import BackEndTypes, ModelTypes
...
def decide(backend):
    ...
    if backend == BackEndTypes.Sklearn:
        ...
        from dice_ml_local.model_interfaces.base_model import BaseModel
        return BaseModel
        ...
        from dice_ml_local.model_interfaces.keras_tensorflow_model import \
        ...
        from dice_ml_local.model_interfaces.pytorch_model import PyTorchModel
        return PyTorchModel
