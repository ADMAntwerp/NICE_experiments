...
from dice_ml_local import diverse_counterfactuals as exp
from dice_ml_local.constants import ModelTypes
...
class DiceGenetic(ExplainerBase):
    ...
    def compute_proximity_loss(self, x_hat_unnormalized, query_instance_normalized):
        ...
        if len(self.data_interface.continuous_feature_indexes)==0:
            return 0
        else:
